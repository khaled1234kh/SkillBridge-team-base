...
_TOPIC_CURATED = {
    ...
    "docker": [
        ...
        _lesson_res(
            ...
            "Docker",
            topics=("build", "multi-stage", "advanced", "images"),
            levels=("Intermediate", "Advanced"),
            reason="Official overview of Docker Build, including multi-stage builds and BuildKit.",
        ),
        _lesson_res(
            "doc",
            "Docker security",
            ...
            "Docker",
            topics=("security", "secrets", "hardening", "non-root", "dockerfile"),
            levels=("Intermediate", "Advanced"),
            reason="Official security guidance for images, containers, and runtime settings.",
        ),
        _lesson_res(
            "doc",
            "Docker secrets",
            ...
            "Docker",
            topics=("secrets", "security", "swarm", "dockerfile"),
            levels=("Advanced",),
            reason="How to manage sensitive data with Docker secrets in Swarm.",
        ),
        _lesson_res(
            "doc",
            ...
            "Docker",
            topics=("orchestration", "swarm", "cluster", "scaling", "services"),
            levels=("Advanced",),
            reason="Official overview of Docker Swarm clustering and service orchestration.",
        ),
    ],
    "deep learning": [
        _lesson_res(
